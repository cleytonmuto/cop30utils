...
function sortNames(inputText: string): string[] {
    ...
    return lines.sort((a, b) => a.localeCompare(b, 'pt-BR', { sensitivity: 'base' }));
}
...
function SortNames() {
    ...
    const handleSort = () => {
        const sorted = sortNames(inputText);
    ...
    return (
        <>
            <h1 className="mb-3">Ordenar Nomes</h1>
            <div className="card p-3 bg-dark text-light border-secondary">
                <div className="alert alert-info mb-3">
                    <small>
                        ...
                        O sistema ordenará os nomes em ordem alfabética crescente.
                    </small>
                </div>
